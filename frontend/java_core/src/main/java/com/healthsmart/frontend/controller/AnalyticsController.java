...
public class AnalyticsController {
    ...
    private static Map<String, Object> handleDashboard(String body) {
        ...
        try {
            ...
            // 获取周统计
            var weeklyStats = analyticsService.getWeeklyStatisticsByUserId(userId);
    ...
    private static Map<String, Object> handleWeeklyStats(String body) {
        ...
        try {
            Integer userId = ((Number) data.get("userId")).intValue();
            var stats = analyticsService.getWeeklyStatisticsByUserId(userId);
    ...
    private static Map<String, Object> handleNutritionTrend(String body) {
        ...
        try {
            Integer userId = ((Number) data.get("userId")).intValue();
            Integer planId = data.containsKey("planId") ? ((Number) data.get("planId")).intValue() : null;
            var trend = planId != null ?
                analyticsService.getNutritionTrend(planId) :
                analyticsService.getNutritionTrendByUserId(userId);
