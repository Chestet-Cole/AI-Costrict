...
public class PlanController {
    ...
    private static Map<String, Object> handleGenerate(String body) {
        ...
        try {
            ...
            // 获取最新的健康报告
            HealthReport report = reportService.getLatestReport(userId);
            if (report == null) {
                response.put("success", false);
    ...
    private static Map<String, Object> dailyTaskToMap(DailyTask task) {
        ...
        map.put("stepsGoal", task.getStepsGoal());
        
        // 执行状态
        map.put("breakfastCompleted", task.isBreakfastCompleted());
        map.put("lunchCompleted", task.isLunchCompleted());
        map.put("dinnerCompleted", task.isDinnerCompleted());
        map.put("exerciseCompleted", task.isExerciseCompleted());
        map.put("waterCompleted", task.isWaterCompleted());
        map.put("sleepCompleted", task.isSleepCompleted());
